...
for t in range(90, 100):
 ...
 # [89],[90],[91],[92],[93],[94],[95]]
    ...
    # update: 3.6 FIX
    with open('./results_FIX/angle-bert-base-uncased-nli-en-v1-results/EVAL-single-pass-ByBody_results.txt', 'a') as file: # ByBody
    ...
    # update: 3.6 FIX
    file_name = f'./results_FIX/angle-bert-base-uncased-nli-en-v1-results/index-single-pass-ByBody-ANGLE-LOAD_results_{threshold}.txt' # ByBody
